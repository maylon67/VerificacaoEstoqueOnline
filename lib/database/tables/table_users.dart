...
final String fieldUsersUserid = 'id';
final String fieldUsersPermissions = 'permissions';
final String fieldUsersLastLogin = 'lastLogin';
final String fieldUsersLogged = 'logged';